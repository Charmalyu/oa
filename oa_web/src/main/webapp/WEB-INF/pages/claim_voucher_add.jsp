                    ...
                    <div class="panel-body bg-light">
                        ...
                        <div class="section">
                            <label for="claimVoucher.cause" class="field prepend-icon">
                                <form:input path="claimVoucher.cause" required="true" cssClass="gui-input" placeholder="事由..."/>
                            ...
                            <div>
                                ...
                                <div class="col-md-3">
                                    <label for="items[0].amount" class="field prepend-icon">
                                        <form:input path="items[0].amount" required="true" cssClass="gui-input money" placeholder="金额..."/>
